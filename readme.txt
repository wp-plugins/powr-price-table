...
POWr Price Table lets you compare multiple plans, products, and features in a side-by-side display.  Edit right in your web page!

== Description ==
POWr Price Table is a free cloud-based application.  Create a POWr account to add, edit, and customize POWr Plugins right in your webpage.
<br>
<br>
To use Price Table, download and install the plugin, then add to your site as a widget or a shortcode in any post or page: **[powr-banner-slider]**

<blockquote>
= <a href='https://www.powr.io/plugins/price-table'>Download</a>  |  <a href='http://www.powr.io/tutorials/how-to-add-price-table-plugin-to-your-wordpress-site'>Install Help</a>  |  <a href='http://www.powr.io/knowledge-base'>Knowledge Base</a>  |  <a href='http://www.powr.io/plugins'>More from POWr</a> =
<br>
</blockquote>
...
= How do I add Price Table to a page or blog post? = Add the shortcode **[powr-price-table label='Enter any label here']** to any page or post. Then visit your live site to edit.

= Can I add more than one Price Table? = Yes, absolutely!  To clone your Price Table, just add the exact same shortcode to pages or posts.  To create a new version of Price Table, add a different shortcode to each page or post, for example: **[powr-price-table label='first form']**, and **[powr-price-table label='second form']**.
