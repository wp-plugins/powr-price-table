<?php
    ...
    Description: Showcasing pricing of your products, plans, and other offerings. Add the widget to your theme, or create a Price Table on ANY page or post by using the shortcode [powr-price-table]. Then, simply visit your site and click the settings icon to customize your Price Table right in the page. Many more plugins & tutorials at POWr.io.
    Author: POWr.io
    Version: 1.0
    ...
    */
    ...
    class Powr_Price_Table extends WP_Widget{
      ...
      public function form( $instance ){
        ?>
        <p>
          No need to edit here - just click the gears icon on your Price Table.
        </p>
        <p>
